...
declare const makeWASocket: (config: UserFacingSocketConfig) => {
    ...
    createNewsLetter: (name: string, desc?: string | undefined, picture?: import("../Types").WAMediaUpload | undefined) => Promise<import("../Types").NewsLetterMetadata>;
    ...
    updateNewsletterPicture: (jid: string, picture: import("../Types").WAMediaUpload) => Promise<import("../Types").NewsLetterMetadata>;
